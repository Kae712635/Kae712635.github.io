    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="h-12 min-w-12 px-3 sm:px-4 rounded-full bg-[#1e1d1b]/95 border border-[#8A897C]/50 hover:border-[#D4AF37] hover:bg-[#415D43]/30 text-[#EEE2DF] shadow-[0_8px_25px_rgba(0,0,0,0.6)] backdrop-blur-md transition-all flex items-center justify-center gap-2 text-xs font-cinzel font-bold tracking-wider uppercase group focus-visible:outline-none"
        >
          <svg className="w-5 h-5 text-[#D4AF37] group-hover:scale-110 transition-transform shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        ...
        <button
          ...
          className={`h-12 min-w-12 px-3 sm:px-4 rounded-full border shadow-[0_8px_25px_rgba(0,0,0,0.6)] backdrop-blur-md transition-all flex items-center justify-center gap-2 text-xs font-cinzel font-bold tracking-wider uppercase group focus-visible:outline-none relative ${
            hasActiveA11ySettings 
              ? 'bg-[#415D43] text-white border-[#415D43]' 
              : 'bg-[#1e1d1b]/95 border-[#8A897C]/50 hover:border-[#415D43] hover:bg-[#415D43]/30 text-[#EEE2DF]'
          }`}
        >
          {/* Universal Accessibility Icon */}
          <svg className="w-5 h-5 text-[#EEE2DF] group-hover:scale-110 transition-transform shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          {hasActiveA11ySettings && (
            <span 
              className="absolute -top-1 -right-1 w-3.5 h-3.5 bg-[#D4AF37] rounded-full border-2 border-[#1e1d1b]" 
